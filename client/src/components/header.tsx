        ...
        <div className="flex justify-between items-center h-20 lg:h-28">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3" data-testid="logo-container">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs lg:text-sm text-white hidden sm:block">Reliable & Affordable Rides in KZN</span>
            </div>
          </div>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="lg:hidden text-white hover:text-yellow-400 hover:bg-gray-800" data-testid="button-mobile-menu">
